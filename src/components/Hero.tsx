    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 text-foreground">
          Find Your Perfect
          <span className="block text-farm-green">Farm or Farmstall</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
          Discover agricultural properties, working farms, and local farmstalls in your area. 
          From organic vegetables to farm-fresh produce.
        </p>
        ...
        <div className="max-w-2xl mx-auto bg-card/90 backdrop-blur-sm rounded-xl p-6 shadow-farm border border-border/20">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <Input 
                placeholder="Search farms, farmstalls, or produce"
                className="pl-10 h-12 border-farm-green/20 focus:border-farm-green"
              />
            </div>
